...
export default function Reviews() {
    ...
    return (
        <div>
            <div className="mx-auto max-w-7xl px-6 sm:px-8  bg-white">
                <div>
            ...
            <div className='bg-lightblue px-4  my-8 sm:flex py-16 sm:justify-around'>
                <div className=' text-sm sm:text-lg text-white'>
                    ...
                    <h1 className=' text-xl sm:text-4xl font-bold mt-2'>Start your Free trail now!</h1>
                </div>
                <div className='sm:flex sm:space-x-4 text-white mt-8 sm:mt-0'>
                    ...
                    <button className='bg-btngreen w-full px-6 h-12 mt-3 sm:mt-0 rounded-sm text-sm '>Start Free Trail</button>
                </div>
            </div>
        </div>
    );
